define([], function() {
	...
	var configuration = {
		...
		route: [
			...
			{'state': 'hostList', 'url': CONTEXT_ROOT + '/hosts', 'templateUrl': PARTIALS_ROOT + 'host.index.php', 'controller': 'HostListCtrl'},
			...
			{'state': 'hostShow', 'url': CONTEXT_ROOT + '/hosts/:id', 'templateUrl': PARTIALS_ROOT + 'host.show.php', 'controller': 'HostShowCtrl'},
			{'state': 'serviceList', 'url': CONTEXT_ROOT + '/services', 'templateUrl': PARTIALS_ROOT + 'service.index.php', 'controller': 'ServiceListCtrl'},
			{'state': 'serviceShow', 'url': CONTEXT_ROOT + '/services/:id', 'templateUrl': PARTIALS_ROOT + 'service.show.php', 'controller': 'ServiceShowCtrl'},
